      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 text-left">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="flex-1">
                ...
                Tu perfil Certired reúne tu información y certificaciones para que no dependas más del papel ni de archivos sueltos o aislados. Todo queda en un solo lugar, registrado dentro de CertiRed y disponible para que las empresas puedan consultarlo.
                </p>
                ...
                >
                  Registrar mi Perfil <ArrowRight size={20} />
                </Link>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/3 flex flex-col items-center relative mt-12 lg:mt-0 lg:mb-[-100px] z-20">
                <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                 ...
                 <div className="w-[110%] -mt-12 relative z-10 bg-white p-6 rounded-xl border border-deep-blue/10 shadow-xl">
                    ...
                    Tus capacitaciones quedan registradas y validadas dentro de CertiRed, para que tu perfil sea confiable y fácil de consultar por las empresas.
                    </p>
                </div>
            </div>
