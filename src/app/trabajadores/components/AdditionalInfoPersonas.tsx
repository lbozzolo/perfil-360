      ...
      <div className="py-16 bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="text-text-gray space-y-4 max-w-3xl mx-auto text-center">
                <p>
                    Certired es gratuito para trabajadores. Sin embargo, la emisión/digitalización de una certificación (gestión de carga, validación y registro) puede tener un arancel definido por el Centro de Capacitación que la emite. Si aplica, se informa al momento de solicitar la carga.
                </p>
                <p className="font-bold text-perfil-blue">
                    Certired no te cobra por tener tu perfil. Si existe un costo por emitir/cargar una certificación, es un servicio del centro que la valida.
                </p>
            </div>
        </div>
      </div>
