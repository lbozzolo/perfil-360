  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16 text-justify text-gray-800 flex-grow">
        ...
        <p className="mb-4">Los valores vigentes serán informados dentro de la plataforma o por los canales oficiales de Certired.<br/>Los pagos realizados no son reembolsables, salvo disposición legal en contrario.<br/>www.perfil360.com.ar</p>
        ...
        <p className="mb-4">Certired podrá modificar los presentes Términos y Condiciones en cualquier momento.<br/>Las modificaciones serán publicadas en el sitio web oficial.<br/>El uso continuado de la plataforma implicará la aceptación automática de las modificaciones introducidas.<br/>www.perfil360.com.ar</p>
