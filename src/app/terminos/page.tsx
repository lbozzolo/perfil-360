...
export const metadata: Metadata = {
  ...
  description:
    "Leé los Términos y Condiciones de uso de la plataforma Certired. Conocé las reglas que rigen el acceso, utilización y permanencia en la plataforma.",
  robots: { index: false, follow: false },
  openGraph: {
    title: "Términos y Condiciones de Uso | Certired",
    url: "https://www.certired.com.ar/terminos",
  },
};
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16 text-justify text-gray-800 flex-grow">
        <h1 className="text-2xl md:text-3xl font-bold mb-6">TÉRMINOS Y CONDICIONES DE USO – CERTIRED</h1>
        <p className="mb-2 text-sm text-gray-500">Última actualización: 09 de febrero del 2026</p>
        <p className="mb-6">Al registrarse, acceder o utilizar la plataforma Certired, el usuario declara haber leído, comprendido y aceptado expresamente los presentes Términos y Condiciones de Uso, los cuales regulan el acceso, utilización y permanencia en la plataforma.</p>
        <h2 className="text-lg font-bold mt-8 mb-2">1. Descripción del servicio</h2>
        <p className="mb-4">Certired es una plataforma digital privada de trazabilidad laboral y formativa, destinada a la gestión, registro, visualización y vinculación de información relacionada con:</p>
        ...
        <p className="mb-4">La información registrada tiene una finalidad informativa, operativa y documental, y puede ser utilizada como soporte de respaldo en procesos de control, auditoría, supervisión, verificación o cumplimiento normativo por parte de empresas, centros de capacitación, aseguradoras de riesgos del trabajo (ART), organismos de control u otros terceros interesados.<br/>Certired no constituye un registro público oficial, ni reemplaza registros estatales, administrativos o gubernamentales, ni sustituye resoluciones, habilitaciones, licencias o dictámenes emitidos por autoridades competentes.<br/>www.certired.com.ar</p>
        ...
        <p className="mb-4">El usuario declara que toda la información ingresada en la plataforma es veraz, completa, actualizada y de su exclusiva responsabilidad.<br/>Certired no valida de oficio la veracidad legal, técnica o normativa de los datos cargados, salvo cuando se indique expresamente lo contrario mediante procesos específicos habilitados dentro de la plataforma.<br/>Cada actor que carga información asume plena responsabilidad por los datos registrados y por las consecuencias derivadas de su utilización.<br/>www.certired.com.ar</p>
        <h2 className="text-lg font-bold mt-8 mb-2">4. Derecho de uso de la plataforma</h2>
        <p className="mb-4">Certired otorga a los usuarios un derecho de uso no exclusivo, no transferible y revocable para acceder y utilizar la plataforma conforme a estos Términos y Condiciones.<br/>Queda prohibido:</p>
        <ul className="list-disc pl-6 mb-4">
        ...
        <p className="mb-4">La información registrada en Certired es cargada por usuarios identificables y responsables, tales como centros de capacitación, empresas, instructores, evaluadores u otros actores habilitados.<br/>Certired no certifica oficialmente capacitaciones, competencias ni relaciones laborales, ni garantiza la exactitud, vigencia o validez legal de la información cargada.<br/>La plataforma funciona como sistema de registro, trazabilidad y visualización, y no como autoridad certificante.</p>
        ...
        <p className="mb-4">Los valores vigentes serán informados dentro de la plataforma o por los canales oficiales de Certired.<br/>Los pagos realizados no son reembolsables, salvo disposición legal en contrario.<br/>www.certired.com.ar</p>
        <h2 className="text-lg font-bold mt-8 mb-2">7. Responsabilidad y limitaciones</h2>
        <p className="mb-4">Certired no asume responsabilidad por decisiones laborales, contractuales, legales o administrativas tomadas por terceros en base a la información visualizada en la plataforma.<br/>El uso de la información es responsabilidad exclusiva de quien la consulta o utiliza.<br/>Certired no será responsable por daños directos o indirectos derivados del uso o interpretación de los datos registrados.</p>
        <h2 className="text-lg font-bold mt-8 mb-2">8. Propiedad intelectual</h2>
        <p className="mb-4">La plataforma Certired constituye una obra de software original e inédita, protegida por las leyes de propiedad intelectual vigentes.<br/>El diseño, la arquitectura funcional, la lógica operativa, los flujos de navegación, la estructura de datos, la interfaz, los contenidos y la documentación asociada se encuentran protegidos, incluyendo su registro como obra inédita de software conforme a la normativa aplicable.<br/>Queda prohibida la reproducción total o parcial, copia, adaptación, ingeniería inversa, explotación comercial o utilización no autorizada de la plataforma o de cualquiera de sus componentes.<br/>El uso de la plataforma no otorga al usuario ningún derecho de propiedad sobre la misma.</p>
        <h2 className="text-lg font-bold mt-8 mb-2">9. Modificaciones de los términos</h2>
        <p className="mb-4">Certired podrá modificar los presentes Términos y Condiciones en cualquier momento.<br/>Las modificaciones serán publicadas en el sitio web oficial.<br/>El uso continuado de la plataforma implicará la aceptación automática de las modificaciones introducidas.<br/>www.certired.com.ar</p>
        <h2 className="text-lg font-bold mt-8 mb-2">10. Legislación aplicable y jurisdicción</h2>
        <p className="mb-4">Los presentes Términos y Condiciones se rigen por las leyes vigentes de la República Argentina.<br/>Cualquier controversia derivada del uso de la plataforma será sometida a la jurisdicción de los tribunales competentes, salvo disposición legal en contrario.<br/>www.certired.com.ar</p>
      </main>
      <Footer />
    </div>
  );
