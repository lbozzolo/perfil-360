...
import { Play, User, Briefcase, Award, ArrowRight } from 'lucide-react';

export default function Hero() {
  return (
    <section className="relative bg-white overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-32">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left z-10 max-w-4xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-bg-light border border-border-gray mb-6">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-deep-blue leading-[1.1] mb-6 tracking-tight">
              Un perfil único. <span className="text-transparent bg-clip-text bg-gradient-to-r from-perfil-blue to-connection-teal">Toda la información laboral.</span>
            </h1>
            
            <p className="text-lg md:text-xl text-text-gray mb-10 max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12">
              <button className="w-full sm:w-auto px-8 py-4 bg-perfil-blue text-white font-bold rounded-full hover:bg-deep-blue transition-all flex items-center justify-center gap-2 shadow-lg shadow-perfil-blue/25 hover:-translate-y-1">
              ...
              <Link 
                href="#" 
                className="w-full sm:w-auto px-8 py-4 border-2 border-border-gray text-perfil-blue font-bold rounded-full hover:border-perfil-blue hover:bg-white transition-all text-center hover:-translate-y-1"
              >
                Ver directorio
              </Link>
            </div>
            
            <div className="flex items-center justify-center lg:justify-start gap-8 pt-8 border-t border-border-gray">
              ...
              <div className="text-sm">
                <p className="font-bold text-perfil-blue">+10.000 Trabajadores</p>
                <p className="text-text-gray">Ya tienen su perfil verificado</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-auto lg:flex-none flex justify-center lg:justify-end relative z-10">
            {/* Decorative circles */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-connection-teal/10 to-360-yellow/10 rounded-full blur-3xl -z-10" />
