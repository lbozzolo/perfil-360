  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.126.555 4.124 1.528 5.862L.057 23.215a.75.75 0 0 0 .928.928l5.353-1.471A11.943 11.943 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.9 0-3.686-.5-5.23-1.376a.75.75 0 0 0-.582-.067l-3.768 1.034 1.034-3.768a.75.75 0 0 0-.068-.583A9.956 9.956 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
      </svg>
    </a>
  );
}
