  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white">
      ...
      <main className="flex-grow max-w-3xl mx-auto px-4 py-12">
        ...
        <ul className="list-disc pl-6 mb-4 text-gray-700">
          <li>permitir el funcionamiento de la plataforma Certired;</li>
        ...
        <ul className="list-disc pl-6 mb-4 text-gray-700">
          ...
          <li>utilizar los servicios de Certired,</li>
        ...
        <p className="mb-4 text-gray-700">Certired adopta medidas técnicas y organizativas razonables para proteger los datos personales contra:</p>
        <ul className="list-disc pl-6 mb-4 text-gray-700">
        ...
        <p className="mb-4 text-gray-700">Certired no comercializa ni cede datos personales a terceros ajenos al ecosistema de la plataforma.</p>
        ...
        <p className="mb-4 text-gray-700">Determinada información puede ser visualizada por terceros habilitados (empresas, centros de capacitación, ART u organismos), únicamente con fines de verificación, trazabilidad o control, y siempre dentro del entorno de Certired.</p>
