      ...
      <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center gap-8 md:gap-16">
        ...
        <div className="w-full md:w-2/3 text-left">
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Certired te permite gestionar el ciclo de vida real de una certificación. Si una certificación vence, el centro puede detectarlo, accionar y renovar. Esto mejora el servicio al trabajador y aporta valor a empresas, que muchas veces no detectan a tiempo vencimientos críticos.
            </p>
        </div>
